...
internal inline fun callAndVerify(expectedReturn: Int = 0, block: () -> Int): Unit {
    block().also {
...
internal inline fun callAndVerify(firstExpectedReturn: Int, secondExpectedReturn: Int, block: () -> Int): Unit {
    block().also {
