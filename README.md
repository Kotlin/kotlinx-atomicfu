...
[![Maven Central](https://img.shields.io/maven-central/v/org.jetbrains.kotlinx/atomicfu)](https://search.maven.org/artifact/org.jetbrains.kotlinx/atomicfu/0.30.0-beta/pom)
...
buildscript {
  ...
  dependencies {
    classpath("org.jetbrains.kotlinx:atomicfu-gradle-plugin:0.30.0-beta")
  }
}
...
```xml
<properties>
     <atomicfu.version>0.30.0-beta</atomicfu.version>
</properties> 
```
...
```groovy
atomicfu {
  dependenciesVersion = '0.30.0-beta'
}
```
...
```groovy
atomicfu {
  dependenciesVersion = '0.30.0-beta' // set to null to turn-off auto dependencies
